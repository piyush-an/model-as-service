...
@bentoml.service(
    name="zero_shot_classifier_service",
    resources={"cpu": "2"},
    workers=2,
    traffic={"timeout": 30},
    tracing={
...
class ZeroShotClassificationService:
    def __init__(self) -> None:
        # Initializing a zero-shot classification pipeline using a specific model
    ...
    def classify(self, **params: typing.Any) -> dict:
        ...
        with bentoml.monitor("text_classification") as mon:
            ...
            # Determining the index of the label with the highest score
            ...
            # Returning the label and its corresponding score as output
